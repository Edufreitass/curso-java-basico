package com.loiane.cursojava.aula36.exercicios.ex02;
...
public class Teste {
	 ...
	 * também pode ter vários alunos (tipo Aluno). Cada Aluno tem nome, matricula e
	 * 4 notas. Escreva um programa teste que crie um Curso com 5 alunos, e que
	 * preça para o usuário entrar com as 4 notas de cada aluno. Ao final, imprima a
	 * média de cada aluno, se o mesmo está aprovado (media maior ou igual a 7), e
